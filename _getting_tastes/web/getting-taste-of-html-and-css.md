---
layout: tutorial
title: Getting taste of HTML and CSS
...
__IMAGE:__ Download the `profile.png` image from here {% include util/download-image.html url="/assets/img/getting-tastes/profile.png" %}.
